---
title: Brackey’s Game Jam 2025.2 – Summary
date: '2025-09-04'
description: 'Seven days, one risk-and-reward theme, and a first game jam: how Alien
  Miner came to life.'
url: /brackeys-game-jam-2025-2-summary/
topics:
- build-log
- launches
- studio-notes
...
1. **Risky paths platformer**: Collect coins on dangerous routes, bank them at checkpoints to keep them safe. Die before banking = lose everything.
2. **Speedrun paths**: A safe but slow route vs. a fast but deadly one.
3. **Bet your HP**:  Start each level betting health. Win = doubled HP. Lose = permanently gone.
...
[**Alien Miner on Itch.io**](https://cybernetks.itch.io/alien-miner)
